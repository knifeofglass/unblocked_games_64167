...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Unblocked thunder game 92s" },
    { name: "description", content: "unblocked thunder games 92" },
  ];
}
  ...
  return (
    <>
      <header className="mb-6">
        <h1 className="text-3xl font-bold text-center">Unblocked thunder games 92</h1>
      </header>
